            ...
            <div className={Style.maincontainer}>
              <div className={Style.container1}>
                ...
                <div className={Style.text}>
                  ...
                  <h3>Site Plan - </h3>
                  <p>
                    Main Building, Walkways, 16 <br /> parking spaces, green
                    area. <br />
              ...
              <div className={Style.container2}>
                ...
                <div className={Style.text}>
                  <h2>Proposed Development - </h2>
                  <p>
                    The building is designed for your luxury living which
                    provides an exciting experiences and ambience for a
                    befitting home for class and style
                  </p>
                  <h3>Site Plan - </h3>
                  <p>
                    Main Building, Walkways, 16 <br /> parking spaces, green
